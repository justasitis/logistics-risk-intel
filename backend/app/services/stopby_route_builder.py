...
from services.geo_antimeridian import (
    normalize_geometry_antimeridian,
    normalize_longitude,
    split_antimeridian,
)
...
# 날짜변경선 정규화는 services/geo_antimeridian.py 공용 구현을 사용한다
# (dashboard_geo_service의 overview 경로에도 같은 정규화가 필요 — SKBA 버그).
# 하위호환 별칭:
_normalize_longitude = normalize_longitude
_split_antimeridian = split_antimeridian
_normalize_geometry_antimeridian = normalize_geometry_antimeridian
